Generate and install the app icon for /tmp/hhh-travel-link.
...
/tmp/hhh-travel-link/app/src/main/res/drawable/icon.png
...
App name: HHH Travel Link
Type: shop
Primary color: #5B294F
...
```text
professional 512 by 512 vector app icon, bold high-contrast lettering "HTL" combined with shopping bag, price tag, storefront accent, product silhouettes integrated into the design, solid opaque colored rounded-square canvas using #5B294F, clearly rounded app-icon corners with transparent pixels outside the rounded canvas, perfectly centered composition, all shapes complete and uncut, clean flat vector illustration, sharp and fully legible typography, commercial app icon quality
...
After saving icon.png, validate it with `bash /home/codex-agent/codex-app-agent/validate-icon.sh /tmp/hhh-travel-link/app/src/main/res/drawable/icon.png`.
