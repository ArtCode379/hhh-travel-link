package hhhcosmetics.luggage.hhhtravellink

import android.app.Application
//[ANY][import_PrepRepository]
import hhhcosmetics.luggage.hhhtravellink.di.dataModule
import hhhcosmetics.luggage.hhhtravellink.di.dispatcherModule
import hhhcosmetics.luggage.hhhtravellink.di.viewModule
...
class QJIOOApplication : Application() {
    //[FIREBASE][appScope]
    ...
    override fun onCreate() {
        ...
        startKoin {
            androidLogger()
            androidContext(this@QJIOOApplication)
            modules(appModules)
        }
